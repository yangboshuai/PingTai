...
module Control
  ...
  module PublicControl #公共控件
    ...
    #pageinfo信息
    SPAN_PAGEINFO=Hash[:class=>"pageinfo",:text=>"Information requested is not found."]
  ...
  module FunctionControl #功能管理页面Function
  ...
  module OrganizationControl #组织管理页面Organization
  ...
  module RolesControl  #角色管理页面Roles
    #主目录Roles
